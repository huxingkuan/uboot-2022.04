 ...
 * Copyright 2017 NXP
 *
 * Configuration settings for the Freescale i.MX6UL 100ask emmc board.
 */
	...
	"ip=dhcp nfsroot=${serverip}:${nfsroot},v3,tcp\0" \
		...
		"findfdt="\
			"if test $fdt_file = undefined; then " \
				...
				"if test $board_name = 100ASK_EMMC && test $board_rev = 14X14; then " \
					"setenv fdt_file 100ask_imx6ull-14x14.dtb; fi; " \
				"if test $fdt_file = undefined; then " \
